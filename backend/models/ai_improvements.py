...
class AIImprovementsModel(Base):
    ...
    # Foreign keys to link with user and question
    ...
    # Attributes directly from attempts
    last_attempt_id: Mapped[str] = Column(String(255), ForeignKey("attempt.attempt_id"), nullable=False)
    previous_attempt_id: Mapped[str] = Column(String(255), ForeignKey("attempt.attempt_id"), nullable=False)
    ...
    def to_dict(self):
        return {
            ...
            # Fetching details from related models
            ...
            "previous_attempt": self.previous_attempt.to_dict()
        }
